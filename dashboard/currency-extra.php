                                ...
                                <form method="post" action="./engine/edit-currency.php">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled placeholder="Currency Type" value="Premium" name="currency-type">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" class="form-control" placeholder="The cost of each unit of <?php echo $row1['Currency_Name']; ?>" name="unit-cost" required min="0.01" max="10000000">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Per Unit Cost of <?php echo $row1['Currency_Name']; ?>(INR)(Required)</label>
                                                <input type="number" step="0.01" class="form-control" placeholder="The cost of each unit of <?php echo $row1['Currency_Name']; ?>" value="<?php echo $row3['Unit_Cost']; ?>" name="unit-cost" required min="0.01" max="10000000" readonly="readonly">
                                            </div>
                                        </div>
