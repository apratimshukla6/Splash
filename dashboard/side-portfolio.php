...
include './engine/portfolio-amount.php';   
...
<head>
	...
	<title>Splash | Your Portfolio</title>
...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <?php
                         ...
                         $score = $sum + ($row3['Account_Balance'])*0.5;
                         $tier = "N/A";
                        
                        if ($score >= 0 and $score < 50000)
                        {
                            $tier = "Bronze";
                        }
                        else if ($score > 50000 and $score < 100000)
                        {
                            $tier = "Silver";
                        }
                        else if ($score > 100000 and $score < 300000)
                        {
                            $tier = "Gold";
                        }
                        else if ($score > 300000 and $score < 700000 )
                        {
                            $tier = "Platinum";
                        }
                        else if ($score > 700000 and $score < 1500000 )
                        {
                            $tier = "Diamond";
                        }
        ...
        $query20 = "INSERT INTO user_portfolio (ID,Tier) VALUES ('$id','$tier')";
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Investment Portfolio</h4>
                                <p class="text-info">Your Credit Score: <b><?php echo $score; ?></b></p>
                                <p class="text-info">Your Tier: <b><?php echo $tier; ?></b></p>
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    <thead>
                                     ...
                                     <tbody>
                                        ...
                                        <tr>
                                        	<td>700000 - 1500000</td>
                                        	<td>Diamond</td>
                                        	
                                        </tr>
                                        <tr>
                                        	<td>Greater than 1500000</td>
                                        	<td>Crown</td>
