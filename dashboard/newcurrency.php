...
<head>
	...
	<title>Splash | New Currency</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Create a New Currency</h4>
                            </div>
                            <div class="content">
                                <form method="post" action="./engine/create-currency.php">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>API Token (Auto-Generated)</label>
                                                <input type="text" class="form-control" readonly="readonly" placeholder="API Token" value="<?php echo $apitoken; ?>" name="api-token">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Currency Name(Required)</label>
                                                <input type="text" class="form-control" placeholder="Name of your Currency" name="currency-name" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Currency Amount(Required)</label>
                                                <input type="number" class="form-control" placeholder="Total amount of Currency in circulation" min="1" max="1000000000" name="currency-amount" step="1" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control" placeholder="A general description about your Currency" name="currency-desc"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Currency Type(Required)</label>
                                                <select class="form-control" name="currency-type" required>
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">BUILD IT!</button>
