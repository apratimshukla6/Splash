...
$query2 = "SELECT * From initiate_trade WHERE Initiator_Wallet_ID='$wallet_id' AND Trade_Status=0";
$sql2 = mysqli_query($mysqli, $query2); 
$query3 = "SELECT * From initiate_trade WHERE Initiator_Wallet_ID='$wallet_id' AND Trade_Status=1";
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Pending Trades initiated by you</h4>
                                <p class="category">Note:The <b>Secure Key</b> is required by the acceptor to complete the trade.</p>
                            </div>
                                    ...
                                    <tbody>
                                       <?php
                                        ...
                                        while($row = mysqli_fetch_array($sql2)){
                                         ...
                                         ?>
                                        <tr>
                                        	<td><?php   echo   $row['Acceptor_Wallet_ID']  ;    ?></td>
                                        ...
                                        <td><?php   echo   $row['Generated_Key'] ;    ?></td>

                                        <td><?php   echo   $row['Trade_Timestamp'] ;    ?></td>
                                    
                                        <td><form method="post" action="./engine/cancel-trade.php"><input type="hidden" value="<?php   echo  $trade_id;    ?>" name="trade-id"><button type="submit" class="btn btn-info btn-fill"><i class="pe-7s-trash"></i> Cancel</button></form></td>
                    ...
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h4 class="title">Completed Trades initiated by you</h4>
                                <p class="category">Your trades which have been successfully completed.</p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                    ...
                                    <tbody>
                                        <tr>
                                         ...
                                         while($row = mysqli_fetch_array($sql3)){
                                            ...
                                            $sql5 = mysqli_query($mysqli, $query5);
                                            $row5 = mysqli_fetch_assoc($sql5);   
                                            $query6 = "SELECT * From trade_records WHERE Trade_ID=$trade_id";
                                            $sql6 = mysqli_query($mysqli, $query6);
                                            $row6 = mysqli_fetch_assoc($sql6); 
                                         ?>
                                        <tr>
                                        <td><?php   echo   $row6    ['Trade_ID']  ;  ?></td>
                                        ...
                                        <td><?php   echo   $row6['Trade_Result'] ;    ?></td>
