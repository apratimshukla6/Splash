...
else
{
    ...
    //second dropdown
    $sql3 = "SELECT * From wallet WHERE ID=$id";
...
<head>
	...
	<title>Splash | Create a New Trade</title>
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">New Trade</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Initiate a New Trade</h4>
                                <p class="category">Note: The currencies you want to trade with must be added to your wallet.</p>
                            </div>
                            <div class="content">
                                <form method="post" action="./engine/launch-trade.php">
                                    <div class="row">
                                        <div class="col-md-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Trader Wallet ID(Required)</label>
                                                <input type="number" class="form-control" placeholder="Enter the Wallet ID of the User you want to trade with" min="100000" max="999999" name="trader-id" step="1" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Currency Amount you want to Send(Required)</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Currency you want to Receive(Required)</label>
                                                    <select name="receive-id" class="form-control" required>
                                                    <?php while ($row1 = mysqli_fetch_assoc($retval3))
                                                    {
                                                    $cid = $row1['Currency_ID'];
                                                    $sql2 = "SELECT * From currency WHERE Currency_ID=$cid";
                                                    $retval2 = mysqli_query( $mysqli, $sql2 );
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Currency Amount you want to Receive(Required)</label>
                                                <input type="number" class="form-control" placeholder="Enter the amount of currency you want to receive" min="1" max="1000000000" name="receive-amount" step="1" required>
                                            </div>
                                        </div>
                                    </div>

                                    <button type="submit" class="btn btn-info btn-fill pull-right">Initiate Trade!</button>
