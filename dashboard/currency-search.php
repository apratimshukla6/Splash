...
<head>
	...
	<title>Splash | Currency Search</title>
...
function showHint(str) {
    if (str.length == 0) { 
        ...
        xmlhttp.open("GET", "./engine/search.php?q=" + str, true);
        xmlhttp.send();
    }
}
</script>
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">Currency Search</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Search for a Currency on Splash</h4>
                            </div>
                            <div class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Name of the Currency you want to search" name="currency-name" required onkeyup="showHint(this.value)"><br>
